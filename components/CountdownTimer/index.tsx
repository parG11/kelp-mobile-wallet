    ...
    <View style={styles.countdownContainer}>
      <View>
        <View style={styles.numberCardWrapper}>
          {numberSplitter(timeLeft?.days as number, 2).map((value, idx) => (
            <View
              key={idx}
              style={[
                styles.numberCard,
              ...
              <PoppinsBold style={styles.countdownMainText}>{value}</PoppinsBold>
            </View>
          ))}
        </View>
        <PoppinsBold
      ...
      <View>
        <View style={styles.numberCardWrapper}>
          {numberSplitter(timeLeft?.hours as number, 2).map((value, idx) => (
            <View
              key={idx}
              style={[
                styles.numberCard,
      ...
      <View>
        <View style={styles.numberCardWrapper}>
          {numberSplitter(timeLeft?.minutes as number, 2).map((value, idx) => (
            <View
              key={idx}
              style={[
                styles.numberCard,
      ...
      <View>
        <View style={styles.numberCardWrapper}>
          {numberSplitter(timeLeft?.seconds as number, 2).map((value, idx) => (
            <View
              key={idx}
              style={[
                styles.numberCard,
